...
<head>
    ...
    <title>Administrator sign-in - CpsuVotewisely.com</title>
    ...
    <div class="login-wrapper">
        ...
        <div class="right-section">
            <div class="form-header">
                ...
                <p>This page is for <strong>administrators only</strong>. Use your registered admin email and password.</p>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-container">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required
                            autofocus autocomplete="username" class="form-input" placeholder="Enter your admin email">
                    </div>
                    <p class="text-xs text-gray-500 mt-1.5">Not for student accounts.</p>
                </div>
