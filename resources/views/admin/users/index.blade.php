...
@section('content')
    <div class="space-y-6">
        <!-- Header Actions -->
        <div class="flex flex-wrap items-center justify-between gap-4 users-header">
            <div>
            ...
            <div class="flex flex-wrap items-center gap-3 users-header-actions">
                <button type="button" onclick="openCreateModal()"
                    class="btn-cpsu-primary inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-lg transition-colors shadow-sm btn-add">
            ...
            <div class="card rounded-lg p-4 stat-card-gold">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-1 stat-value-gold">
            ...
            <div class="card rounded-lg p-4 stat-card-primary">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-1 stat-value-green">
                            {{ \App\Models\User::where('usertype', 'student')->count() }}</p>
                    </div>
                    <div class="w-12 h-12 rounded-lg flex items-center justify-center shadow-md"
                        style="background: linear-gradient(135deg, var(--cpsu-green) 0%, var(--cpsu-green-light) 100%);">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card rounded-lg shadow-sm overflow-hidden">
            <div class="overflow-x-auto users-table-wrap">
                <table class="min-w-full users-table" style="border-collapse: separate; border-spacing: 0;">
                    <thead class="table-header">
                        <tr>
                            <th scope="col"
                                class="px-4 py-3 text-left text-xs font-semibold text-secondary uppercase tracking-wider border-b"
                                style="border-color: var(--border-color); min-width: 200px;">
                                User
                            </th>
                            <th scope="col"
                                class="px-4 py-3 text-left text-xs font-semibold text-secondary uppercase tracking-wider border-b"
                            ...
                            <th scope="col"
                                class="px-4 py-3 text-left text-xs font-semibold text-secondary uppercase tracking-wider border-b"
                                style="border-color: var(--border-color); min-width: 100px;">
                                Type
                            </th>
                            <th scope="col"
                            ...
                            <tr class="table-row transition-colors border-b" style="border-color: var(--border-color);"
                                ...
                                <td class="px-4 py-4 align-middle">
                                    @if ($user->is_super_admin)
                                        <span
                                            ...
                                            style="background: linear-gradient(135deg, var(--cpsu-gold-dark) 0%, var(--cpsu-gold) 100%);">
                                            Super Admin
                                        </span>
                                ...
                                <td class="px-4 py-4 align-middle text-center">
                                    ...
                                    @else
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-white"
                                            style="background: linear-gradient(135deg, var(--cpsu-gold) 0%, var(--cpsu-gold-light) 100%); color: var(--cpsu-green-dark);">
                                            Unverified
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-4 align-middle text-center actions-cell">
                                    <div class="flex flex-nowrap items-center justify-center gap-1">
                                        ...
                                        <button type="button"
                                            onclick="deleteUser({{ $user->id }}, {{ json_encode($user->name) }})"
        ...
        <div class="modal-content">
            ...
            <form id="userForm" onsubmit="saveUser(event)">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="passwordFields">
                            <div>
                                ...
                                <p class="text-xs text-secondary mt-1" id="passwordHint">Leave blank to keep current
                                    password</p>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"
                        class="btn-cpsu-primary px-4 py-2 text-sm font-medium rounded-lg transition-colors">
