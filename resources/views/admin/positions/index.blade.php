    ...
    <div class="space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-4 page-header-wrap">
            ...
            <div class="flex flex-wrap items-center gap-3 page-header-actions">
                <select id="organizationFilter" onchange="filterByOrganization(this.value)"
                    ...
                    <thead class="table-header">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-center text-xs font-semibold text-secondary uppercase tracking-wider border-b"
                                style="border-color: var(--border-color);">Order</th>
                            <th class="px-4 py-3 text-center text-xs font-semibold text-secondary uppercase tracking-wider border-b"
                            ...
                            <tr class="table-row transition-colors border-b" style="border-color: var(--border-color);">
                                <td class="px-4 py-4">
                                    ...
                                    @if ($position->description)
                                        <div class="text-xs text-secondary mt-1">
                                            {{ Str::limit($position->description, 50) }}</div>
                                    @endif
                                </td>
                                <td class="px-4 py-4">
                                ...
                                <td class="px-4 py-4 text-center">
                                    <span
                                        ...
                                        {{ $position->number_of_slots ?? 1 }}
                                    </span>
                                </td>
                                <td class="px-4 py-4 text-center">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $position->is_active ? 'text-white' : 'text-gray-600' }}"
                                        style="{{ $position->is_active ? 'background: linear-gradient(135deg, var(--cpsu-green) 0%, var(--cpsu-green-light) 100%);' : 'background: rgba(0, 0, 0, 0.1);' }}">
        ...
        <div class="modal-content">
            ...
            <form id="positionForm" method="POST">
                ...
                <div class="modal-body space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-primary mb-2">Organization <span
                    ...
                    <div>
                        <label class="block text-sm font-medium text-primary mb-2">Position Name <span
                                class="text-red-500">*</span></label>
        ...
        <div class="modal-content" style="max-width: 400px;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="confirmDelete()"
                    ...
                    style="background: #dc2626;">Delete Position</button>
            </div>
        </div>
    </div>
    ...
    @push('scripts')
        <script>
            ...
            function openCreateModal() {
                ...
                document.getElementById('number_of_slots').value = '1';
            ...
            function editPosition(id) {
                fetch(`/admin/positions/${id}`, {
                    ...
                    .then(data => {
                        ...
                        document.getElementById('number_of_slots').value = data.number_of_slots ?? 1;
            ...
            function showNotification(message, type) {
                ...
                ) + '</div><div class="flex-1"><p class="font-medium">' + message + '</p></div>';
            ...
            document.getElementById('positionForm').addEventListener('submit', function(e) {
                ...
                fetch(url, {
                    ...
                    .then(res => {
                        ...
                        if (res.ok) {
                            closeModal();
                            showNotification(currentPositionId ? 'Position updated successfully.' :
                                'Position created successfully.', 'success');
                            setTimeout(() => location.reload(), 800);
                            return;
                        }
                        if (isJson) return res.json().then(data => {
                            throw data;
                        });
                        throw {
