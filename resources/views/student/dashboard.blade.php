...
<head>
    ...
    <title>Student Dashboard - Votewisely.cpsu</title>
...
<body class="antialiased">
    ...
    <div class="logout-preloader" id="logoutPreloader">
        <div class="logout-preloader-content">
            ...
            <div class="logout-subtext">Thank you for using Votewisely.cpsu</div>
        </div>
        <div class="logout-progress-bar">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div>
                            <h1 class="text-lg sm:text-xl font-bold text-white heading-font">Votewisely.cpsu</h1>
