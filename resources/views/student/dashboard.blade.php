...
<head>
    ...
    <title>Student Dashboard - CpsuVotewisely.com</title>
    ...
    <style>
        ...
        * {
        ...
        .vote-btn-disabled:hover {
            transform: none;
            box-shadow: 0 4px 14px -2px rgba(20, 83, 45, 0.25);
        }
...
<body class="antialiased">
    ...
    <div class="logout-preloader" id="logoutPreloader">
        <div class="logout-preloader-content">
            ...
            <div class="logout-subtext">Thank you for using CpsuVotewisely.com</div>
        </div>
        <div class="logout-progress-bar">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div>
                            <h1 class="text-lg sm:text-xl font-bold text-white heading-font">CpsuVotewisely.com</h1>
            ...
            <div class="space-y-6">
                ...
                <div class="election-card p-5 sm:p-6 lg:p-8" data-election-id="{{ $election->id }}">
                    ...
                    @if($election->status === 'ongoing' && $election->candidatesByPosition && $election->candidatesByPosition->count() > 0)
                        ...
                        @elseif(!empty($election->vote_disabled_course))
                            <div class="mt-5 pt-5 border-t border-gray-100">
                                @include('student.partials.election-not-eligible-course', ['election' => $election, 'showDisabledVoteButton' => true])
                            </div>
                        @elseif(!empty($election->vote_disabled_capacity))
                            <!-- Voter capacity reached — election stays visible, voting closed for new voters -->
                            <div class="mt-5 pt-5 border-t border-gray-100">
                                <div class="rounded-xl p-5 sm:p-6 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/80 shadow-sm">
                                    <div class="flex flex-col sm:flex-row sm:items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            <h4 class="text-base sm:text-lg font-semibold text-amber-950 heading-font mb-1">Voting is full for this election</h4>
                                            <p class="text-sm text-amber-900/90 leading-relaxed">
                                                Thank you for your interest. This election has already reached the allowed number of voters, so new ballots are no longer being accepted.
                                            </p>
                                            <p class="text-xs text-amber-800/80 mt-2 leading-relaxed">
                                                If more students should be able to participate, your election administrator can raise the voter capacity in the election settings.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @elseif($election->status === 'ongoing')
                        @if(!empty($election->vote_disabled_course))
                            <div class="mt-5 pt-5 border-t border-gray-100">
                                @include('student.partials.election-not-eligible-course', ['election' => $election, 'showDisabledVoteButton' => false])
                            </div>
                        @else
