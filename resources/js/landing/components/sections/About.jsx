        ...
        <section id="about" className="py-16 sm:py-20 lg:py-24 xl:py-32 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <SectionTitle
                    ...
                    description="CPSU Voting is a comprehensive cloud-based voting platform that brings transparency, security, and real-time capabilities to student council elections."
                />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mt-10 sm:mt-12 lg:mt-16">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
                            ...
                            logs, and bank-grade security, CPSU Voting ensures every voice is heard 
